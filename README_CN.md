...
2. 出门前：先"忽略此网络"断开 WiFi → iPhone 瞬间切到 5G → WDA 保持连接
...
>
> **日常也需要做"忽略网络"这一步。** 直接走出 WiFi 范围**不能**可靠保持 WDA 连接——iPhone 会在弱信号上死撑很久，导致 TCP tunnel 在切到 5G 之前超时断开。"忽略此网络"是瞬间切换，iOS 能干净地切到 5G。
>
> ---
>
> **为什么这样做？背后的原理：**
